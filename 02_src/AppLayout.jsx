      ...
      <div>
        ...
        <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse} className='sider'>
          <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
            ...
            <SubMenu key="sub3" icon={<ShoppingCartOutlined />} title="检测试剂">
              <Menu.Item key="7"><Link to="/admin/tests/qb">勤邦</Link></Menu.Item>
              <Menu.Item key="8"><Link to="/admin/tests/dylz">达原绿洲</Link></Menu.Item>
            </SubMenu>
            <Menu.Item key="9" icon={<CloudSyncOutlined />}>
            <Link to="/admin/data">数据库</Link>
            </Menu.Item>
          </Menu>
        </Sider>
